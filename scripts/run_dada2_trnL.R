...
pdf(file.path(top_outdir, "pooled_error_model_forward.pdf"))
plotErrors(errF, nominalQ = TRUE)
dev.off()

pdf(file.path(top_outdir, "pooled_error_model_reverse.pdf"))
...
for (i in seq_along(sample_names)) {
  ...
  pdf(file.path(outdir, "asv_length_histogram.pdf"))
  ...
  # Save outputs
  # -------------------------------------------------------------------
  saveRDS(dadaF, file.path(outdir, "dadaF.rds"))
  saveRDS(dadaR, file.path(outdir, "dadaR.rds"))
  saveRDS(mergers, file.path(outdir, "merged_pairs.rds"))
